        ...
        <div class="col-md-8">
            <div class="glass-card p-5 animate-up">
                <div class="mb-4 d-flex align-items-center">
                    ...
                    <h2 class="fw-bold m-0 text-white">Editar Producto</h2>
                </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" rows="3"
                                class="form-control bg-dark text-white border-secondary @error('description') is-invalid @enderror">{{ old('description', $product->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
